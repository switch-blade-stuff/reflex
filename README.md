...
In order to build the library as a static or dynamic target, a C++20 - capable compiler is required (with a GCC/Clang or
MSVC compatible syntax) and CMake with minimal version 3.20.
